...
<head>
   ...
   <link rel="alternate stylesheet" type="text/css" href="styles/bluecollarpet.css" title="bluecollarpet" media="all" />
   <link rel="alternate stylesheet" type="text/css" href="styles/delicatepet.css" title="delicatepet" media="all" />
   <link rel="alternate stylesheet" type="text/css" href="styles/maincolors.css" title="maincolors" media="all" />
   <link rel="alternate stylesheet" type="text/css" href="styles/tropicalpet.css" title="tropicalpet" media="all" />
   <link rel="alternate stylesheet" type="text/css" href="styles/sweetpet.css" title="sweetpet" media="all" />
   <!-- END Demo Examples -->
   </head>
   <body id="page-top">
  <!-- Start Switcher -->
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="predefined_styles">
               ...
               <!-- MODULE #3 -->
               <a href="bluecollarpet.html" class="styleswitch"><img src="switcher/images/bluecollarpet.png" alt="Blue Collar Pet"></a>      
               <a href="delicatepet.html" class="styleswitch"><img src="switcher/images/delicate.png" alt="Delicate Pet"></a>    
               <a href="tropicalpet.html" class="styleswitch"><img src="switcher/images/tropical.png" alt="Tropical Pet"></a>    
               <a href="sweetpet.html" class="styleswitch"><img src="switcher/images/sweet.png" alt="Sweet Pet"></a>    
               <a href="maincolors.html" class="styleswitch"><img src="switcher/images/maincolors.png" alt="Main Colors"></a>    
               <!-- END MODULE #3 -->
            </div>
...
<!-- Mirrored from ingridkuhn.com/themes/petz/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 28 Aug 2018 00:44:38 GMT -->
</html>